...
//define CONVEYOR_FWD_ID				L310_TRIGGER_LEFT
//#define CONVEYOR_BCK_ID				L310_TRIGGER_RIGHT
//#define CONVEYOR_ADJUST_LEFT_ID		L310_BUTTON_BUMPER_RIGHT
//#define CONVEYOR_ADJUST_RIGHT_ID	L310_BUTTON_BUMPER_LEFT
#define CONVEYOR_FWD_ID						L310_BUTTON_BUMPER_LEFT
#define CONVEYOR_BCK_ID						L310_BUTTON_BUMPER_RIGHT
#define CONVEYOR_INTAKES_CLOCK_ID			L310_TRIGGER_LEFT
#define CONVEYOR_INTAKES_COUNTERCLOCK_ID	L310_TRIGGER_RIGHT
...
#define CONVEYOR_INTAKES_CW				Controller_1->GetRawAxis(L310_TRIGGER_LEFT)			//not including conveyor
#define CONVEYOR_INTAKES_CCW			Controller_1->GetRawAxis(L310_TRIGGER_RIGHT)
...
#define CUBEAUTO_INCREMENT_ID		L310_BUTTON_START
#define CUBEAUTO_DECREMENT_ID		L310_BUTTON_STOP
#define CANLIFTER_RAISE_ID			L310_THUMBSTICK_LEFT_Y
#define CANLIFTER_LOWER_ID			L310_THUMBSTICK_LEFT_Y
...
#define CANAUTO_OKTORAISE			(!Controller_1->GetPOV())
#define CUBEAUTO_INCREMENT			Controller_2->GetRawButton(L310_BUTTON_START)
#define CUBEAUTO_DECREMENT			Controller_2->GetRawButton(L310_BUTTON_STOP)
#define CUBECLICKER_RAISE			(-Controller_2->GetRawAxis(L310_THUMBSTICK_RIGHT_Y) > 0.75)
#define CUBECLICKER_LOWER			(-Controller_2->GetRawAxis(L310_THUMBSTICK_RIGHT_Y) < -0.75)
#define CANLIFTER_RAISE				(-Controller_2->GetRawAxis(L310_THUMBSTICK_LEFT_Y) > 0.75)
#define CANLIFTER_LOWER				(-Controller_2->GetRawAxis(L310_THUMBSTICK_LEFT_Y) < -0.75)
